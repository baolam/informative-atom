...
from .base_behavior import CodingBehavior, NonCodingBehavior


class BaseUnit(ABC):
    def __init__(self, metadata : dict = None, _id : str = None, *args, **kwargs):
        super().__init__()
...
class HardUnit(BaseUnit, ABC):
    def __init__(self, _id = None, behavior : CodingBehavior = None, *args, **kwargs):
...
class SoftUnit(BaseUnit, ABC):
    def __init__(self, _id = None, behavior : NonCodingBehavior = None, *args, **kwargs):
        super().__init__(_id, *args, **kwargs)
...
class HybridUnit(BaseUnit, ABC):
    ...
    """
    def __init__(self, _id = None, coding_behavior : CodingBehavior = None, non_coding_behavior : NonCodingBehavior = None, *args, **kwargs):
        super().__init__(_id, *args, **kwargs)
